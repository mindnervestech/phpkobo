...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Case.instance'
        db.delete_column(u'logger_case', 'instance_id')

        # Adding M2M table for field instances on 'Case'
        m2m_table_name = db.shorten_name(u'logger_case_instances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('case', models.ForeignKey(orm['logger.case'], null=False)),
            ('instance', models.ForeignKey(orm['logger.instance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['case_id', 'instance_id'])


    def backwards(self, orm):
        # Adding field 'Case.instance'
        db.add_column(u'logger_case', 'instance',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cases', null=True, to=orm['logger.Instance']),
                      keep_default=False)

        # Removing M2M table for field instances on 'Case'
        db.delete_table(db.shorten_name(u'logger_case_instances'))
    ...
    models = {
        ...
        'logger.case': {
            ...
            'case_id': ('django.db.models.fields.TextField', [], {}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instances': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['logger.Instance']", 'symmetrical': 'False'}),

					...
					if (!tempForm.getJson().isEmpty()) {
						...
						for (int i = 0; i < headerArr.length(); i++) {
							try {
								...
								//
								if(rec.getString("name").equals("group_mp2ce86") || rec.getString("name").equals("group_il76c07") || rec.getString("name").equals("group_yn5ag22") || rec.getString("name").equals("group_tg43g44") || rec.getString("name").equals("group_pu7nj29") || rec.getString("name").equals("group_rp78i53") || rec.getString("name").equals("group_uh9ru92") || rec.getString("name").equals("group_nx3ad21") || rec.getString("name").equals("group_fy83z32") || rec.getString("name").equals("group_bp1ga51") || rec.getString("name").equals("group_zm4kh27") || rec.getString("name").equals("group_cf8gh38") || rec.getString("name").equals("group_jp4we63") || rec.getString("name").equals("group_ab8np57") || rec.getString("name").equals("group_kg2ry91") || rec.getString("name").equals("group_fe2ud57") || rec.getString("name").equals("group_lh92g49") || rec.getString("name").equals("group_if9kv81") || rec.getString("name").equals("group_vy3xo71") || rec.getString("name").equals("group_xw13n72") || rec.getString("name").equals("group_mc46c32") || rec.getString("name").equals("group_kk5pj32") || rec.getString("name").equals("group_pt4pq54") || rec.getString("name").equals("group_yd3xa05") || rec.getString("name").equals("group_fi8ft37")){
						...
						while( keys.hasNext() ) {
						    ...
						    if(!key.equals("meta/instanceID") && 
						    		...
						    		try{
						    			...
						    			if(temp.contains("group_yn5ag22") || temp.contains("group_il76c07") || temp.contains("group_mp2ce86") || temp.contains("group_rp78i53") || temp.contains("group_pu7nj29") || temp.contains("group_tg43g44") || temp.contains("group_uh9ru92") || temp.contains("group_nx3ad21") || temp.contains("group_fy83z32") || temp.contains("group_bp1ga51") || temp.contains("group_zm4kh27") || temp.contains("group_cf8gh38") || temp.contains("group_jp4we63") || temp.contains("group_ab8np57") || temp.contains("group_kg2ry91") || temp.contains("group_fe2ud57") || temp.contains("group_pt4pq54") || temp.contains("group_xw13n72")|| temp.contains("group_kk5pj32") || temp.contains("group_mc46c32") || temp.contains("new_form_group_lh92g49") || temp.contains("new_form_group_if9kv81")){

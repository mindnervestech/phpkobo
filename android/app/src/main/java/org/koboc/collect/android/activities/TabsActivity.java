...
public class TabsActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab1.setIndicator(getIndicator("My Loc"));
        tab2.setIndicator(getIndicator("Alert"));
        tab3.setIndicator(getIndicator("My Forms"));
        tab4.setIndicator(getIndicator("My Cases"));


        //tab1.setIndicator("My Loc");
        //tab2.setIndicator("Alert");
        //tab3.setIndicator("My Forms");
        tab1.setContent(new Intent(this, NearstLocation.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));


        tab2.setContent(new Intent(this, AlertActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));

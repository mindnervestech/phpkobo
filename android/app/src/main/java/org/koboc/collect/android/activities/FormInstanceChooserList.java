 ...
 */
public class FormInstanceChooserList extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Collect collect=(Collect)getApplicationContext();
       ...
       /* Cursor c = managedQuery(ContentUris.withAppendedId(InstanceColumns.CONTENT_URI,
                collect.index), null, null, null, null);*/
